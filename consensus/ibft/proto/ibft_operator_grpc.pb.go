...
const (
	...
	IbftOperator_GetValidatorPrivateKey_FullMethodName = "/v1.IbftOperator/GetValidatorPrivateKey"
)
...
type IbftOperatorClient interface {
	...
	GetValidatorPrivateKey(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetValidatorPrivateKeyResp, error)
}
...
func (c *ibftOperatorClient) GetValidatorPrivateKey(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*GetValidatorPrivateKeyResp, error) {
	out := new(GetValidatorPrivateKeyResp)
	err := c.cc.Invoke(ctx, IbftOperator_GetValidatorPrivateKey_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IbftOperatorServer interface {
	...
	GetValidatorPrivateKey(context.Context, *emptypb.Empty) (*GetValidatorPrivateKeyResp, error)
...
func (UnimplementedIbftOperatorServer) GetValidatorPrivateKey(context.Context, *emptypb.Empty) (*GetValidatorPrivateKeyResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetValidatorPrivateKey not implemented")
}
...
func _IbftOperator_GetValidatorPrivateKey_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IbftOperatorServer).GetValidatorPrivateKey(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IbftOperator_GetValidatorPrivateKey_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IbftOperatorServer).GetValidatorPrivateKey(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IbftOperator_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetValidatorPrivateKey",
			Handler:    _IbftOperator_GetValidatorPrivateKey_Handler,
		},
	},
