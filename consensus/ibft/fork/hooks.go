...
// registerCustomContractAddressHooks registers hooks to call SXNode's SetValidators()
...
func registerCustomContractAddressHooks(
	...
	hooks.PreCommitStateFunc = func(h *types.Header, t *state.Transition) error {
		...
		_, err = datafeed.SetValidators(t, types.DeadAddress, types.StringToAddress(customContractAddress), validatorAddresses) //nolint:lll
		if err != nil {
