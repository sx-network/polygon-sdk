...
// GetCustomContractAddress returns customContractAddress at specific height if one exists
func (m *ForkManager) GetCustomContractAddress(height uint64) (types.Address, error) {
	fork := m.forks.getFork(height)
	if fork == nil {
