...
func (p *SecretsInit) Run(args []string) int {
	...
	if configPath == "" {
		...
		case secrets.AwsSsm:
			//TODO:
			// setup role for this instance on aws to allow SSM.parameterStore read + write for our key
			// use aws-sdk SSM to create parameterKey for validator.key and libp2p.key
			// https://gist.github.com/miguelmota/bd8a5c7942a3587544bcc7cef6bd80de
